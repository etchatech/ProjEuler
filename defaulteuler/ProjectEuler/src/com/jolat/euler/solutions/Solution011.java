...
public class Solution011 extends AbstractCommand
{
	private final int[][]	arrz	=
									{
	...
	public String execute ()
	{
		...
		// for (int j = 0; j < arrz[i].length; i++) {
		//
		// }
		// }
		return "did it manually 87 97 94 89 = 70600674";
	}
	
	@Override
	public String getSolutionDetails ()
	{
		return "In the 2020 grid below, four numbers along a diagonal line have been marked in red.\n"
